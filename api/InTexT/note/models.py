...
class Note(db.Model):
    ...
    templet = db.Column(db.String(50), nullable=False)
    ...
    def getnote(self, global_id):
        ...
        templet = str(note.templet)

        data = {"content": content, "note_title": note_title, "update_time": update_time,
                "create_time": create_time, "author": author, "is_del": is_del, "templet": templet}
